...
public class SudokuGenerator {
     ...
     * @param n
     */
    private void genShuduKnow(int n) {
        // 生成n个已知格子
     ...
     * @return
     */
    private boolean isOnlyAnswer(int[][] data, int i, int j) {
     ...
     * @return
     */
    private int getMinknow(int[][] data, int p, int q) {
        int temp = data[p][q];
        int minKnow = 9;
        int tempKnow = 9;
        data[p][q] = 0;
     ...
     * @return
     */
    private boolean put(int[][] data, int n, ArrayList<Point> blankList) {
        if (n < blankList.size()) {
     ...
     * @return
     */
    private boolean validateIandJ(int[][] data, int x, int y) {
